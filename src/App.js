    ...
    <div className="bg-white dark:bg-slate-800">
      <nav className="py-10 mb-12 flex justify-between bg-indigo-900 text-white">
        <ul className="flex items-center ml-10">
          ...
          <li className="pr-5 over:bg-violet-600 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300"><a href="#about">About</a></li>
          <li className="pr-5 over:bg-violet-600 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300"><a href="#projects">Projects</a></li>
          <li className="pr-5 over:bg-violet-600 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300"><a href="#contact">Contact Me</a></li>
          <li className="pr-0 over:bg-violet-600 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300"><a href="#">Resume</a></li>
        </ul>
